...
function sidebar() {
  $("#sidebar")
    .html(render("sidebar"))
    .find(".login").on("click", function() {
      login();
    })
    .end()
    .find(".connect").on("click", function() {
      connect();
    });
}
